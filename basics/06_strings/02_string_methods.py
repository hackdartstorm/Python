#String Functions
name = "ram is a good good Boy 2323"
...
print(name.isspace()) #if the str is empty and minimum there will be one character then return true else false 
...
print(name.split()) #Return a list of the substrings in the string, using sep as the separator string.
